...
import com.github.tekiflo.aoc.day5.Day5.BoardingPass
...
class Day5Spec extends AnyFlatSpec with Matchers {
  ...
  it should "correctly parse the input" in {
    val parsed  = Day5.parseInput(input)
  ...
  it should "return the correct result for part 1 given the test input" in {
    val passes = Day5.parseInput(input)

    Day5.highestSeatId(passes) mustBe 820
  }
}
