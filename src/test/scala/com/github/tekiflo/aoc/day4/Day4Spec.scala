...
class Day4Spec extends AnyFlatSpec with Matchers {
  ...
  it should "return the correct result for part 1 given the test input" in {
    ...
    Day4.countValidPassportsPart1(passports) mustBe expectedResult
  }
  ...
  it should "not validate invalid passports" in {
    ...
    Day4.countValidPassportsPart2(passports) mustBe 0
  }
  ...
  it should "validate valid passports" in {
    ...
    Day4.countValidPassportsPart2(passports) mustBe passports.size
  }
}
